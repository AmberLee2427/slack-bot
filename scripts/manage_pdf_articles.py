...
def main():
    ...
    parser.add_argument("--config", default="config/articles.yml", 
                       help="Path to PDF articles configuration file")
    parser.add_argument("--base-path", default="knowledge_base/raw",
                       help="Base path for PDF articles")
    parser.add_argument("--list", action="store_true",
                       help="List all configured PDF articles")
    parser.add_argument("--clean", action="store_true",
                       help="Remove PDF articles not in configuration")
